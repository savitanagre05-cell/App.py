...
st.markdown("""
    ...
    .neon-card { background: rgba(255, 255, 255, 0.07); padding: 20px; border-radius: 20px; border: 2.5px solid #FFBB00; margin-bottom: 20px; }
    
    /* 📱 FIXED BOTTOM NAV (No Scroll) */
    .fixed-nav {
        position: fixed; bottom: 0; left: 0; width: 100%;
        background: rgba(10, 10, 10, 0.98); border-top: 1px solid #444;
        display: flex; justify-content: space-around;
        padding: 12px 0px; z-index: 9999;
    }
    ...
    .next-btn button {
        ...
        font-weight: bold !important; border-radius: 12px !important; padding: 15px !important;
        border: none !important; margin-top: 10px !important;
    }

    .main-title { color: #00f2ff; text-align: center; font-size: 26px; font-weight: bold; }
    .sub-title { color: #FFBB00; text-align: center; font-size: 16px; margin-bottom: 15px; }
