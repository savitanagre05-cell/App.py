...
# --- मुख्य ॲप (Login नंतर) ---
    ...
    if st.session_state.page == "Home":
        ...
        if st.session_state.selected_car is None:
            ...
            if pay == "PhonePe":
                st.info("PhonePe Number: 9309146504")
