...
# --- मुख्य ॲप (Login नंतर - Bottom Navigation सह) ---
else:
    # १. Home Page
    ...
    # ५. Bottom Navigation Bar (नेहमी खाली दिसेल)
    st.markdown('<div style="height: 100px;"></div>', unsafe_allow_html=True) # स्पेससाठी
