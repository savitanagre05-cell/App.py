...
# ================= SESSION =================
# IMPORTANT:
# No splash loop, no time.sleep(), no automatic rerun.
# This prevents the app from getting stuck on the BALAJI screen.
...
if not st.session_state.logged_in:
    ...
    # Language option - available before login too.
    lang = st.selectbox(
        "🌐 Language / भाषा",
        ["English", "मराठी", "हिंदी"],
        index=["English", "मराठी", "हिंदी"].index(
        ...
        if st.button(
            ...
            if not new_username or not new_mobile or not new_password:
                ...
                if exists:
                    ...
                    # Customer does NOT need to login again.
                    st.session_state.logged_in = True
...
# ================= MAIN APP =================
    ...
    # ========================================================
        ...
        # Toll/extra charges are NOT included in fare.
        st.markdown("""
        ...
        st.info(
            f"Estimated Ride Fare: ₹{fare:.2f}  |  Toll/Parking: Extra"
        )
        ...
        if payment == "Online":
            ...
            encoded_qr_data = urllib.parse.quote(
                upi_url,
                safe=""
            )
        ...
        if st.button(
            ...
            if not pickup or not drop:
                ...
                if payment_file:
                    ...
                    screenshot_path = str(
                        UPLOAD_DIR / f"{booking_id}_{filename}"
                    )
                ...
                message = (
                    ...
                    f"💰 Ride Fare: ₹{fare:.2f}\n"
                    f"💳 Payment: {payment}\n"
                    "🛣️ Toll/Parking/other applicable extra charges: "
