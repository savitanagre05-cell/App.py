...
# =========================================================
    ...
    current_mobile_row = conn.execute(
        "SELECT mobile FROM users WHERE username = ?",
        (st.session_state.user,),
    ).fetchone()
    ...
    current_mobile = (
        current_mobile_row["mobile"]
        if current_mobile_row
        else ""
    )
...
# =========================================================
    ...
    if not st.session_state.admin_authenticated:
        ...
        if not df.empty:
            ...
            current_status = (
                selected_row["status"]
                if selected_row["status"] in statuses
                else "Confirmed"
            )
