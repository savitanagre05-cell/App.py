...
# Streamlit version - original features kept + stability fixes
# ============================================================
...
.balaji-card {
    ...
    padding:20px;
    border-radius:15px;
    box-shadow:0 0 15px rgba(255,187,0,.25);
    text-align:center;
}
...
def new_booking_id():
    # Microseconds prevent same-second duplicate IDs.
...
def flash_screen():
    # IMPORTANT:
    # No time.sleep() and no forced st.rerun().
    # This avoids blocking the Streamlit server on startup.
...
if not st.session_state.logged_in:
    ...
    <div class="balaji-card">
        <h2 style="color:#FFBB00;margin-bottom:4px;">🚩 BALAJI LOGISTICS</h2>
        <p style="color:#bbbbbb;">Tours & Travels</p>
        <p style="color:#999;font-size:12px;">🌍 Maharashtra & All India Service</p>
    </div>
    """, unsafe_allow_html=True)
...
# ================= MAIN APP =================
    ...
    if st.session_state.page == "Home":
        ...
        st.markdown("""
        <div class="balaji-card">
            <h3 style="color:#FFBB00;">🚩 BALAJI LOGISTICS</h3>
            <p style="font-weight:bold;">Tours & Travels</p>
    ...
    # ========================================================
            ...
            st.markdown(
                ...
                text-align:center;border:2px solid #5f259f;">
                    ...
                    display:inline-block;border-radius:10px;">
                        <img
                        src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data={encoded_qr_data}"
                        width="180">
                    </div>
        ...
        if st.button(
            ...
            if not pickup or not drop:
                ...
                st.warning(
                    "Pickup and Drop locations should be different."
                )
                ...
                booking_time = datetime.now(IST).strftime(
                    "%Y-%m-%d %H:%M:%S"
                )
