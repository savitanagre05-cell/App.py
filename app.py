        ...
        if auth_mode == "Register":
            if name and mob and pwd:
                ...
                if str(mob) in df['Mobile'].astype(str).values:
                    ...
                    st.success("नोंदणी यशस्वी! आता 'Login' निवडा.")
            else:
...
# --- लॉगिन नंतरचा भाग ---
    ...
    st.sidebar.title("Balaji Logistics and Tours and Travels")
    ...
    # इथून पुढे तुमचा गाडी निवडीचा आणि किलोमीटर कॅल्क्युलेटरचा कोड सुरू होईल...
    st.info("लॉगिन यशस्वी! प्रवासाची माहिती भरा.")