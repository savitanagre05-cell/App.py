...
# ================= MAIN APP =================
    ...
    if st.session_state.page == "Home":
        ...
        # 🚗 CAR IMAGE (FIXED WORKING)
        st.markdown("""
        <div style="text-align:center;">
            <img src="https://cdn.pixabay.com/photo/2016/11/18/12/34/car-1835506_1280.jpg"
            style="width:90%; border-radius:20px; box-shadow:0px 0px 20px #00ffcc;">
        </div>
        """, unsafe_allow_html=True)
