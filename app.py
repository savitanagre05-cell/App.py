...
# ==========================================
# 🎨 UI DESIGN (NO SCROLL FIXED MENU)
# ==========================================
st.markdown("""
    <style>
    header, footer, #MainMenu {visibility: hidden;}
    .stApp { background: linear-gradient(135deg, #000 0%, #0a0a2e 100%); color: white; padding-bottom: 80px; }
    .neon-card { background: rgba(255, 255, 255, 0.07); padding: 20px; border-radius: 20px; border: 2px solid #FFBB00; margin-bottom: 20px; }
    
    /* 📱 FIXED BOTTOM NAV (No Scrolling Needed) */
    .fixed-nav {
        position: fixed;
        bottom: 0;
        left: 0;
    ...
    .main-title { color: #00f2ff; text-align: center; font-size: 24px; font-weight: bold; }
    .sub-title { color: #FFBB00; text-align: center; font-size: 15px; margin-bottom: 20px; }
...
if not st.session_state.logged_in:
    ...
    if st.session_state.page == "Home":
        ...
        with st.form("book"):
            ...
            if st.form_submit_button("Confirm Booking ✅"):
                ...
                msg = (f"🚀 *NEW BOOKING* 🚀%0A🚩 *BALAJI TOUR'S AND TRAVELS*%0A👤 Cust: {st.session_state.user}%0A📍 From: {s}%0A🏁 To: {d}%0A🚗 Car: {v}%0A💰 Fare: ₹{fare}%0A💳 Pay: {pay_m}%0A---%0A✅ टोल, पार्किंग, बॉर्डर टॅक्स वेगळा.")
    ...
    # ==========================================
    # 📱 THE FIXED NAV BAR (No Scroll)
    # ==========================================
    # हे CSS आणि Columns एकत्र वापरून आपण तळाला बटन फिक्स केली आहेत
