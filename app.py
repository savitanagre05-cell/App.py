...
BOOKING_COLS = ["booking_id","username","date","from_loc","to_loc","vehicle","fare","pay_mode","cust_mob","screenshot"]
...
# ================= SESSION =================
for k in ["logged_in","user","page","flash_done","payment_done"]:
...
if not st.session_state.flash_done:
    ...
    with ph.container():
        ...
        ">
            <div>
                <h1 style="color:#FFBB00;font-size:50px;">
                    🚩 BALAJI LOGISTICS
                </h1>
...
if not st.session_state.logged_in:
    ...
    st.markdown("<h1 style='text-align:center;color:#FFBB00;'>BALAJI LOGISTICS</h1>", unsafe_allow_html=True)
...
# ================= MAIN APP =================
    ...
    if st.session_state.page == "Home":
        ...
        <div style="text-align:center;">
            <h1 style="color:#FFBB00;font-size:42px;">
                🚩 BALAJI LOGISTICS
            </h1>
            ...
            <p style="color:#00ffcc;">
                🌍 Maharashtra & All India Safe Travel Service
            </p>
            <hr style="border:1px solid #FFBB00;">
        </div>
        """, unsafe_allow_html=True)
...
"""
            ...
            st.markdown(f"[📲 WhatsApp Message](https://wa.me/{WA_LINK_NO}?text={link})")
