...
if not st.session_state.logged_in:
    ...
    if st.session_state.page == "Home":
        ...
        st.markdown(f"<div class='neon-card' style='text-align:center;'><h4>स्वागत आहे, {st.session_state.user}! ✨</h4><p>स्वच्छ गाड्या आणि सुरक्षित प्रवास - आमची ओळख.</p></div>", unsafe_allow_html=True)
    ...
    # --- BOOKING PAGE ---
        ...
        with st.form("book"):
            ...
            if st.form_submit_button("Confirm Booking ✅"):
                ...
                # PREMIUM WHATSAPP MSG WITH NOTES
                msg = (f"🚀 *NEW BOOKING CONFIRMED* 🚀%0A━━━━━━━━━━━━━━━━━━%0A🚩 *BALAJI TOUR'S AND TRAVELS*%0A👤 *Cust:* {st.session_state.user}%0A📍 *From:* {s}%0A🏁 *To:* {d}%0A🚗 *Car:* {v}%0A💰 *Fare:* ₹{fare}%0A💳 *Pay:* {pay_m}%0A━━━━━━━━━━━━━━━━━━%0A📌 *Notes:*%0A✅ टोल, पार्किंग वेगळी असेल.%0A✅ बॉर्डर टॅक्स कस्टमरचा.%0A✅ जादा किमीचे पैसे लागतील.%0A🙏 *Thank You!*")
